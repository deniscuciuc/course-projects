...
public class QuestionsAndAnswers {
    ...
    final Question[] LEVEL_2 = {
            new Question("Intrebarea 1 level 2", ANSWERS_1_LEVEL_1, 1, 100),
            new Question("Intrebarea 2 level 2", ANSWERS_2_LEVEL_1, 1, 100),
            new Question("Intrebarea 3 level 2", ANSWERS_3_LEVEL_1, 1, 100),
            new Question("Intrebarea 4 level 2", ANSWERS_4_LEVEL_1, 1, 100),
    };
    final Question[] LEVEL_3 = {
            new Question("Intrebarea 1 level 3", ANSWERS_1_LEVEL_1, 1, 100),
            new Question("Intrebarea 2 level 3", ANSWERS_2_LEVEL_1, 1, 100),
            new Question("Intrebarea 3 level 3", ANSWERS_3_LEVEL_1, 1, 100),
            new Question("Intrebarea 4 level 3", ANSWERS_4_LEVEL_1, 1, 100),
    };
    final Question[] LEVEL_4 = {
            new Question("Intrebarea 1 level 4", ANSWERS_1_LEVEL_1, 1, 100),
            new Question("Intrebarea 2 level 4", ANSWERS_2_LEVEL_1, 1, 100),
            new Question("Intrebarea 3 level 4", ANSWERS_3_LEVEL_1, 1, 100),
            new Question("Intrebarea 4 level 4", ANSWERS_4_LEVEL_1, 1, 100),
    };
    final Question[] LEVEL_5= {
            new Question("Intreabarea 1 level 5", ANSWERS_1_LEVEL_1, 1, 100),
            new Question("Intrebarea 2 level 5", ANSWERS_2_LEVEL_1, 1, 100),
            new Question("Intrebarea 3 level 5", ANSWERS_3_LEVEL_1, 1, 100),
            new Question("Intrebarea 4 level 5", ANSWERS_4_LEVEL_1, 1, 100),
    };
    ...
    // TODO: print questions and answers (try iterator to iterate answers), takes an object of Question to print
    public void printQuestionsAndAnswers(Question question) {
